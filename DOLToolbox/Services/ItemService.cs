    ...
    public class ItemService
    {
        ...
        public ItemTemplate GetItem(string itemId)
        {
            return DatabaseManager.Database.FindObjectByKey<ItemTemplate>(itemId) ??
                   DatabaseManager.Database.SelectObjects<ItemTemplate>(DB.Column(nameof(ItemTemplate.Id_nb)).IsEqualTo(itemId)).FirstOrDefault();
        }
        ...
        {
            var item = DatabaseManager.Database.SelectObjects<ItemTemplate>(DB.Column(nameof(ItemTemplate.Id_nb)).IsEqualTo(newId)).FirstOrDefault();
