...
namespace DOLToolbox.Forms
{
	public partial class RewardQuestSearchForm : Form
	{
		...
		private List<DBRewardQuest> _allData;
		private List<DBRewardQuest> _data;
		private int _page;
		...
		private void GetPage(bool paging = false)
		{
			...
			var bindingList = new BindingList<DBRewardQuest>(page);
		...
		private DBRewardQuest GetSelected()
		{
			...
			return dataGridView1.SelectedRows[0].DataBoundItem as DBRewardQuest;
		}
